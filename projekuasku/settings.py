"""
Django settings for projekuasku project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-$(!3ub)^dg@%i79*jd^_4m@q0*o#-n@gc_p^23!s8(elmre-vj')
...
WSGI_APPLICATION = 'projekuasku.wsgi.application'
